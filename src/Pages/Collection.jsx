...
const Collection = () => {
  ...
  const [sortType, setSortType] = useState("relvant");
  ...
  return (
    <div className="flex flex-col gap-1 border-t pt-10 sm:flex-row sm:gap-10">
      ...
      <div className="min-w-60">
        ...
        {/* Cartegory Filter */}
        <div
          className={`mt-6 border border-gray-300 py-3 pl-5 ${showFilter ? "hidden" : ""}`}
        >
        ...
        {/* Sub Category Filter */}
        <div
          className={`my-5 border border-gray-300 py-3 pl-5 ${showFilter ? "hidden" : ""}`}
        >
      ...
      <div className="flex-1">
        <div className="mb-4 flex justify-between text-base sm:text-2xl">
          ...
          >
            <option value="relvant">Sort by: Relvant </option>
